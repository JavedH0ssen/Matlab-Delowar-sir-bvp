...
n=0
% disp('1');
  sol1 = bvpinit(linspace(0,1,500),[1 0 1 0 0 1 1 1 0 1 1]);
sol = bvp4c(@bvp2d, @bc2d, sol1); 
  disp('2');
sol1=bvpinit(sol,[0 1]);
sol = bvp4c(@bvp2d, @bc2d, sol1);
sol1=bvpinit(sol,[0 1]);
sol = bvp4c(@bvp2d, @bc2d, sol1);
n=n+1
sol1=bvpinit(sol,[1 1.1]);
sol = bvp4c(@bvp2d, @bc2d, sol1);
% n=n+1
...
% sol1=bvpinit(sol,[0 4]);
% sol = bvp4c(@bvp2d, @bc2d, sol1);
%   disp('3');
% sol1=bvpinit(sol,[3 3.1]);
% sol = bvp4c(@bvp2d, @bc2d, sol1);
%   disp('4');
...
yvector=[y(2);y(3);y(4);yy4;y(6);y(7);yy7;y(9);yy9;y(11);yy11];
    ...
    function residual=bc2d(y0,yinf)
        ...
        residual=[y0(1)-FW;y0(2)-1;y0(5);y0(8)-1;y0(10)-1;yinf(4);yinf(3);
